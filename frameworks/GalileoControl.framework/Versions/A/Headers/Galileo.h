...
/** The current battery level as a percentage of total capacity.
 @discussion This value is an estimate only. The best estimate is obtained when Galileo is stationary and not connected to an external power source.
 */
