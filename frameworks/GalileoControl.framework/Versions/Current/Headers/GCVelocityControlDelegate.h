...
/** This protocol defines an interface for delegates of a `GCVelocityControl` object to be notified when a velocity target has been reached.
 */

#import <Foundation/Foundation.h>

@protocol GCVelocityControlDelegate <NSObject>
